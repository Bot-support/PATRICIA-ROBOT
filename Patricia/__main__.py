...
from Patricia.modules import ALL_MODULES
from Patricia.modules.helper_funcs.chat_status import is_user_admin
from Patricia.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Patricia.modules." + module_name)
...
@run_async
def patricia_about_callback(update, context):
    query = update.callback_query
        ...
        query.message.edit_text(
           ...
           😎\n\n 𝙸𝙵 𝚈𝙾𝚄 𝙷𝙰𝚅𝙴 𝙰𝙽𝚈 𝚀𝚄𝙴𝚂𝚃𝙸𝙾𝙽 𝙰𝙱𝙾𝚄𝚃 patricia 𝙱𝙾𝚃 𝙻𝙴𝚃 𝚄𝚂 𝙺𝙽𝙾𝚆 𝙰𝚃 [𝚂𝚄𝙿𝙿𝙾𝚁𝚃 𝙶𝚁𝙾𝚄𝙿](https://t.me/patricia_support)🇮🇳.""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Back", callback_data="patricia_back")
                 ]
                ]
            ),
        )
    elif query.data == "patricia_back":
        query.message.edit_text(
                PM_START_TEXT,
                reply_markup=InlineKeyboardMarkup(buttons),
                parse_mode=ParseMode.MARKDOWN,
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(patricia_about_callback, pattern=r"patricia_")
